...
public class clsCustomerMasterModel extends clsBaseModel implements Serializable {
	...
	@Id
	@AttributeOverrides({ @AttributeOverride(name = "strCustomerCode", column = @Column(name = "strCustomerCode")),
	...
	/*
	 * @Column(name = "strItemImage") private String strItemImage;
	 * 
	 * @Column(name = "strPreferences") private String strPreferences;
	 * 
	 * @Column(name = "strDesignation") private String strDesignation;
	 * 
	 * @Column(name = "imgImage") private String imgImage;
	 */
	...
	/*
	 * public String getStrItemImage() { return strItemImage; }
	 * 
	 * public void setStrItemImage(String strItemImage) { this.strItemImage =
	 * strItemImage; }
	 * 
	 * public String getStrPreferences() { return strPreferences; }
	 * 
	 * public void setStrPreferences(String strPreferences) { this.strPreferences =
	 * strPreferences; }
	 * 
	 * public String getStrDesignation() { return strDesignation; }
	 * 
	 * public void setStrDesignation(String strDesignation) { this.strDesignation =
	 * strDesignation; }
	 * 
	 * public String getImgImage() { return imgImage; }
	 * 
	 * public void setImgImage(String imgImage) { this.imgImage = imgImage; }
	 * 
	 */
}
