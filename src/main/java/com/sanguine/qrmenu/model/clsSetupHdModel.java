...
public class clsSetupHdModel extends clsBaseModel implements Serializable {
	...
	/*
	 * @Column(name = "strSuperMerchantCode") private String strSuperMerchantCode;
	 */
	/*
	 * @Column(name = "strDayEndSMSYN") private String strDayEndSMSYN;
	 * 
	 * 
	 * 
	 * @Column(name = "strVoidKOTSMSYN") private String strVoidKOTSMSYN;
	 * 
	 * 
	 * @Column(name = "strNCKOTSMSYN") private String strNCKOTSMSYN;
	 * 
	 * 
	 * @Column(name = "strVoidAdvOrderSMSYN") private String strVoidAdvOrderSMSYN;
	 * 
	 * @Column(name = "strVoidBill") private String strVoidBill;
	 * 
	 * 
	 * @Column(name = "strSettleBill") private String strSettleBill;
	 * 
	 * @Column(name = "strModifyBill") private String strModifyBill;
	 * 
	 * 
	 * @Column(name = "strComplimentaryBill") private String strComplimentaryBill;
	 */
	 ...
	 * 
	 * public void setStrDayEndSMSYN(String strDayEndSMSYN) { this.strDayEndSMSYN =
	 * strDayEndSMSYN; }
	 * 
	 * public String getStrVoidKOTSMSYN() { return strVoidKOTSMSYN; }
	 * 
	 * public void setStrVoidKOTSMSYN(String strVoidKOTSMSYN) { this.strVoidKOTSMSYN
	 * = strVoidKOTSMSYN; }
	 * 
	...
	/*
	 * public long getIntTelephoneNo() { return intTelephoneNo; }
	 * 
	 * public void setIntTelephoneNo(long intTelephoneNo) { this.intTelephoneNo =
	 * (Long) setDefaultValue(intTelephoneNo, "0"); }
	 */
	 ...
	 * 
	 * public void setDblMaxDiscount(double dblMaxDiscount) { this.dblMaxDiscount =
	 * (Double) setDefaultValue(dblMaxDiscount, "0.0000"); }
	 */
